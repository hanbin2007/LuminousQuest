...
## M1a.1 复核关闭(2026-07-15)

opus-4.8 独立复核:A/B/C/D 全部关闭,真行为覆盖,反作弊扫描通过,**可合并**;Fable 5 抽验(抽取契约/减电子写法/切片)通过。残留 1 条低危(极性锚点比对未走 normalizeFactValue,偏严方向)并入 M1b。M1a 正式关闭。
